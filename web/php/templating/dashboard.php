    ...
    <div class="controlbox">
        <form id="lightControlForm" action="./endpoint/set" target="dummyframe" method="GET">
            ...
            <div class="row">
                ...
                <input type="range" oninput="changeInput(event, false)" onchange="changeInput(event, true)" step="1" min="0" max="100" name="s" class="saturation" />
            </div>
            <div class="row">
                <a>Luminosity (<span id="luminosityPercentage">0</span>%)</a>
                <input type="range" oninput="changeInput(event, false)" onchange="changeInput(event, true)" step="5" min="0" max="100" name="l" class="luminance" />
            </div>
        </form>
    </div>
</div>